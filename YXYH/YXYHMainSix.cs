...
{
    public partial class YXYHMainSix : Form
    {
        public YXYHMainSix()
        {
            InitializeComponent();
            ...
            lblTemp.Tag = new LabelTag(false, 4208, "环境温度", "℃");
            ...
            try { ChangeLabels(GlobalVariables.dtOneRowDataSix); }
            catch { }
        }
        ...
        string sUnit2HCGR_IDs = "2380,2381,4385,4399";//2号机组好处归热要显示的ID
        DateTime timeGCCollect = DateTime.Now;//系统垃圾回收时间
        DataTable dtControls = TableControlConfig.getDataTableByRowFilter("[Parent] like 'YXYHMainSix.%'");
        DataTable m_dtLineData = GlobalVariables.dtChartDataSix;
        DataView viewTagLabelBinding = TableTagLabelBinding.getAllData().DefaultView;
        DataView viewShowList = null;
        HistoryLines m_frmHistoryLines = new HistoryLines(6);
        SystemGraphSix systemGraph = new SystemGraphSix();
        RunOptimizePromptSix m_frmRunOptimizePrompt = new RunOptimizePromptSix();
        TagLabelBinding tagLabelBinding = new TagLabelBinding(6);
        CalCSWDLLSix calCSWDLLobj = new CalCSWDLLSix();
        string sNewLabel = "";
        LabelTag chart1Series0Tag = new LabelTag(4410, "优化出水温度", "℃");//宋高工让改成了优化温度的上限值，原来是4213,edit by hlt ,2017-1-18
        LabelTag chart1Series1Tag = new LabelTag(4152, "实际出水温度", "℃"); //1233
        LabelTag chart3Series0Tag = new LabelTag(4219, "优化热负荷", "W/㎡"); //meiyou
        LabelTag chart3Series1Tag = new LabelTag(4252, "实际热负荷", "W/㎡"); //meiyou
        LabelTag chart2Series0Tag = new LabelTag(4222, "优化循环水量", "t/h"); //meiyou
        LabelTag chart2Series1Tag = new LabelTag(4505, "实际循环水量", "t/h");
        ...
        void AddConfigedControl()
        {
            ...
            { 
                ...
                foreach (DataRow row in dtControls.Rows)
                {
                    ...
                    parent = TagLabelBinding.GetParentControl(this, row["Parent"].ToString().Replace("YXYHMainSix.", ""));
                    try
                    {
        ...
        void SetBindingLabelsText()
        {
            try
            {
                ...
                LabelTag labelTag = null;
                DataTable dtTagLabelBinding = TableTagLabelBinding.getDataTableByRowFilter("[Parent] like 'YXYHMainSix.%'");
                ...
                lblRunOptimizePromptText.Text = RunOptimizePromptSix.GetPromptText();
                lblRunOptimizePromptText.ForeColor = RunOptimizePromptSix.GetPromptTextForeColor();
        ...
        /// 设置Label的可见性
        /// </summary>
        public void SetLabelVisible(string sRowFilter = "[Parent] like 'YXYHMainSix.%'")
        {
            Control control, parent;
            LabelTag labelTag = null;
            int i = 0; 
        ...
        public void ChangeLabels(DataTable dt)
        {
            ...
            try
            {
                ...
                lblDQY.Text = "大气压力：" + WinHost.TagValue.GetShowValueSix(4004, "", "");
                lblTemp.Text = "环境温度：" + WinHost.TagValue.GetFinishedTagValueSix("F4208").ToString("0.0") + "℃";
                ...
                if (m_bIsFirstRun == false)
                {
                    RunOptimizePromptSix.CalculateRunOptimizePromptType(6);
        ...
        private void btnOrgTD_Click(object sender, EventArgs e)
        {
            ...
            (new TagReplace(6)).Show();
        }

        private void btnHis_Click(object sender, EventArgs e)
        {
            //SelectTagDate selectTagDate = new SelectTagDate(6);
            //HistoryLines historyLines = new HistoryLines(6);
            ...
            SelectTagDate selectTagDate = new SelectTagDate(6,chart1);
            selectTagDate.Show();
        }

        private void btnFixedValueEdit_Click(object sender, EventArgs e)
        {
            (new FixedValueEdit(6)).Show();
        }
        ...
        private void btnAddTag_Click(object sender, EventArgs e)
        {
            ...
            sSql = "insert into ControlConfig(ControlName,ControlX,ControlY,ForeColor,BackColor,Type,Parent,ParentHeight,ParentWidth,UnitNo) values('"
                ...
                + control.Parent.Height + "," + control.Parent.Width + "," + 6 + ")";
            SQLHelper.ExecuteSql(sSql);
        ...
        private void btnResetTotal_Click(object sender, EventArgs e)
        {
            ...
            ResetTotalAvg reset = new ResetTotalAvg(6);
            reset.Show();
        ...
        public void timerDateTime_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (PIRead.IsOperatingPI & (DateTime.Now - PIRead.TimeOfBeginOperatingPI).TotalSeconds > 4)
                    lblDateTime.Text = DateTime.Now.ToLongTimeString() + "  读OPC数据已" + Math.Round((DateTime.Now - PIRead.TimeOfBeginOperatingPI).TotalSeconds, 1) + "秒！";
                //else
                //    lblDateTime.Text = DateTime.Now.ToLongDateString() + "  " + DateTime.Now.ToLongTimeString();

                lblDateTime.Refresh();

                if (lblRunOptimizePromptText.Text != RunOptimizePromptSix.GetPromptText())
                    lblRunOptimizePromptText.Text = RunOptimizePromptSix.GetPromptText();
        ...
        private void rdoHCGD_CheckedChanged(object sender, EventArgs e)
        {
            if (rdoHCGD.Checked == true)
            { 
                SetLabelVisible("[Parent] like 'YXYHMainSix.%' and [TagID] in (" + sUnit2HCGD_IDs + "," + sUnit2HCGR_IDs + ")");
            }
        }
        ...
        {
            (new YHYXYH.YXYH.AlarmListYXYH("YXYH", 6)).Show();
        }
        ...
        {
            GlobalVariables.YXYH_GBY_CN_JS6 = true;
        }

        private void CNGK_CheckedChanged(object sender, EventArgs e)
        {
            GlobalVariables.YXYH_GBY_CN_JS6 = false;
        }
