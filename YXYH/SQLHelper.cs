...
namespace YHYXYH.YXYH
{
    public class SQLHelper
    {
        ...
        public static String GetSqlConnection()
        {
            ...
            string sPath = System.AppDomain.CurrentDomain.BaseDirectory + "\\Config.xml";
            ...
            //String conn = CommonFunction.En_De.DESDecrypt(ConStr, "?$d36tg", "ed4w%");// ConfigurationManager.ConnectionStrings[_connstr].ToString();
            //String conn = ConStr;// ConfigurationManager.ConnectionStrings[_connstr].ToString();
            String conn = @"Server=MTG8HMSMLUQTHIH\SQL2008;Uid=sa;Pwd=sql;DataBase=CJData;";// ConfigurationManager.ConnectionStrings[_connstr].ToString();
            return conn;
        }
        #endregion
        ...
        public static int ExecuteSql(String Sqlstr)
        {
            ...
            {
                WriteLog.WriteLogs("执行sql语句出错"+Sqlstr+" ; "+  e.Message);
                try { WriteLog.WriteLogs("InnerException:" + e.InnerException.Message); }
                catch { }
