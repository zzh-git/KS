...
namespace CJPrj.Cls
{
   public class WASPCNTrancate
    {
      public static int argRange = 0;
      public static void SetSTD_WASP(string stdid)
      {
          WASPCN.WASPCN.SETSTD_WASP(Convert.ToInt16(stdid));
      }
        //获知当前使用的标准
        public static int GETSTD_WASP()
        {
            int stdid = 0;
            WASPCN.WASPCN.GETSTD_WASP(ref stdid);
            return stdid;
        }
       ...
       #region 已知压力P
        ...
        public static double[] P2L(string [] argP)
       {
           double [] argReturn = new double[5];
           
           WASPCN.WASPCN.P2L(Convert.ToDouble(argP[0]), ref argReturn[0], ref argReturn[1], ref argReturn[2], ref argReturn[3], ref argReturn[4], ref argRange);
           return argReturn;
       }
        //已知压力(MPa)，求对应饱和水比焓(kJ/kg)
        public static double[] P2HL(string[] argP)
        {
            double argH = 0.0;
            WASPCN.WASPCN.P2HL(Convert.ToDouble(argP[0]), ref argH, ref argRange);
            return new double[] { argH };
        }
       //已知压力(MPa)，求对应饱和水比熵(kJ/(kg.℃))
       public static double[] P2SL(string[] argP)
       {
           double[] argReturn = new double[1];
           WASPCN.WASPCN.P2SL(Convert.ToDouble(argP[0]), ref argReturn[0], ref argRange);
           return argReturn;
       }
       //已知压力(MPa)，求对应饱和温度(℃)。add by hlt 2014-11-27
       public static double[] P2T(string[] argP)
       {
           double[] argReturn = new double[1];
           WASPCN.WASPCN.P2T(Convert.ToDouble(argP[0]), ref argReturn[0], ref argRange);
           return argReturn;
       }
       //已知压力(MPa)，求对应饱和汽比焓(kJ/kg)。add by hlt 2014-11-27
       public static double[] P2HG(string[] argP)
       {
           double[] argReturn = new double[1];
           WASPCN.WASPCN.P2HG(Convert.ToDouble(argP[0]), ref argReturn[0], ref argRange);
           return argReturn;
       }
       #endregion
       ...
       public static double[] PT2H(string[] argP)
       {
           double[] argReturn = new double[1];
           WASPCN.WASPCN.PT2H(Convert.ToDouble(argP[0]), Convert.ToDouble(argP[1]), ref argReturn[0], ref argRange);
           return argReturn;
       }
       //已知压力(MPa)和温度(℃)，求比熵(kJ/(kg.℃))
        public static double[] PT2S(string [] argP)
        {
            double [] argReturn = new double[1];
            WASPCN.WASPCN.PT2S(Convert.ToDouble(argP[0]),Convert.ToDouble(argP[1]),ref argReturn[0],ref argRange);
            return argReturn;
        }
       #endregion
       ...
       #region 已知压力P和比熵S
        ...
        public static double[] PS2H(string[] argP)
        {
            double [] argReturn = new double[1];
            WASPCN.WASPCN.PS2H(Convert.ToDouble(argP[0]),Convert.ToDouble(argP[1]),ref argReturn[0],ref argRange);
            return argReturn;
        }
        #endregion
       ...
       #region 已知压力P和比焓H
        ...
        public static double[] PH2S(string[] argP)
        {
            double [] argReturn = new double[1];
            WASPCN.WASPCN.PH2S(Convert.ToDouble(argP[0]),Convert.ToDouble(argP[1]),ref argReturn[0],ref argRange);
            return argReturn;
        }
        //已知压力(MPa)和比焓(kJ/kg)，求温度(℃)
        public static double[] PH2T(string [] argP)
        {
            double[] argReturn=new double[1];
            WASPCN.WASPCN.PH2T(Convert.ToDouble(argP[0]),Convert.ToDouble(argP[1]),ref argReturn[0],ref argRange);
            return argReturn;
        }
        #endregion
       ...
       #region 已知温度T
        //已知温度(℃)，求饱和水比焓(kJ/kg)
        public static double[] T2HL(string[] argP)
        {
            double[] argReturn = new double[1];
            WASPCN.WASPCN.T2HL(Convert.ToDouble(argP[0]),ref argReturn[0],ref argRange);
            return argReturn;
        }
        #endregion
